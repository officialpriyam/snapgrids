module.exports = {
    name: 'MiniMessage',
    description: 'The MiniMessage format is a simple string representation of chat components, designed to be easy for end users to learn, and for developers to extend.',
    mavenIntegration: `
     <dependency>
    ...
    `,
    usage: `
        SUPER IMPORTANT: When using MiniMessage, always use Paper API rather than Spigot API.
